...
CREATE TYPE "public"."user_role" AS ENUM('admin', 'tender_officer', 'viewer');--> statement-breakpoint
...
CREATE TABLE "tenders" (
	...
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"updated_at" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "chk_deadline_after_publication" CHECK (submission_deadline > publication_date::timestamp)
);
--> statement-breakpoint
...
ALTER TABLE "custom_field_values" ADD CONSTRAINT "custom_field_values_tender_id_tenders_id_fk" FOREIGN KEY ("tender_id") REFERENCES "public"."tenders"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "custom_fields" ADD CONSTRAINT "custom_fields_deleted_by_id_users_id_fk" FOREIGN KEY ("deleted_by_id") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "tender_team_members" ADD CONSTRAINT "tender_team_members_tender_id_tenders_id_fk" FOREIGN KEY ("tender_id") REFERENCES "public"."tenders"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "idx_custom_field_values_tender_field" ON "custom_field_values" USING btree ("tender_id","custom_field_id");--> statement-breakpoint
...
CREATE INDEX "idx_tender_team_members_tender_user" ON "tender_team_members" USING btree ("tender_id","user_id");--> statement-breakpoint
CREATE INDEX "idx_tender_team_members_user" ON "tender_team_members" USING btree ("user_id");--> statement-breakpoint
...
CREATE INDEX "idx_tenders_created_by" ON "tenders" USING btree ("created_by_id");